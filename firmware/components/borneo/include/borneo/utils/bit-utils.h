...
inline int get_bit_u8(uint8_t value, int bit) 
{
    return value & ((uint8_t)1 << bit);
}

inline int get_bit_u16(uint16_t value, int bit) 
{
    return value & ((uint16_t)1 << bit);
}

inline int get_bit_u32(uint32_t value, int bit) 
{
    return value & ((uint32_t)1 << bit);
}

inline int get_bit_u64(uint64_t value, int bit) 
{
